//
//  ProgressRatioViewController.swift
//  Animation
//
...
import UIKit
// round view
class ProgressRatioViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        pieChartView.segments = [
            ...
            Segment(color: .green, value: 2.5),
            Segment(color: .yellow, value: 3.5),
            Segment(color: .gray, value: 1)
        ]
